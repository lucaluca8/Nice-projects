...
def check_if_row_3_possible(AI_board,line,col):
     if AI_board[line][col] == 0 and AI_board[line][col+1] == 1 and AI_board[line][col+2] == 1:
         return True
     if AI_board[line][col] == 1 and AI_board[line][col+1] == 1 and AI_board[line][col+2] == 0:
         return True
     if AI_board[line][col+1] == 0 and AI_board[line][col] == 1 and AI_board[line][col+2] == 1:
         return True

     return False

def check_if_col_of_3_possible(AI_board,line,col):
    if AI_board[line][col] == 1 and AI_board[line+1][col] == 1 and AI_board[line+2][col] == 0:
        return True
    return False

def find_nearest_col_to_a_1(board,line):
    for c in range(col_c):
        if board[line][c] == 0 and board[line][c+1] == 1 or board[line][c] == 1 and board[line][c+1] == 0:
            return c
    return -1
